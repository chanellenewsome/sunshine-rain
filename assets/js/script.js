...
var getWeatherInfo = function (cityname) {
    var apiCityUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=f28e39815df52d5a49134bb6cd126d1c";
    fetch(
        apiCityUrl
    )
        ...
        .then(function (cityResponse) {
            ...
            return fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + latitude + '&lon=' + longitude + '&exclude=alerts,minutely,hourly&units=imperial&appid=f28e39815df52d5a49134bb6cd126d1c');
        })
